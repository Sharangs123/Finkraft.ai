...
const UserScreen = () => {
  ...
  return (
    <div>
      ...
      <Paper elevation={3} className={classes.profile} sx={{margin:5}}>
        <Avatar alt="User Avatar" src="/path_to_avatar_image.jpg" className={classes.avatar} sizes='large' sx={{padding:2, margin:2}}/>
        <Typography variant="h4" sx={{margin:2}}>John Doe</Typography>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item>
            <Typography variant="body2" sx={{margin:2}}>johndoe@example.com</Typography>
          </Grid>
          <Grid item>
